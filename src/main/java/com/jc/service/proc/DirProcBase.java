...
public class DirProcBase implements DirProcInterface {
	...
	@Override
	public void doProc(GenericParam input, GenericParam output, String dirPath) {

		// ディレクトリ再帰処理を実行する
		doParentDirProc(input, output, dirPath);
	}

	protected void doParentDirProc(GenericParam input, GenericParam output, String dirPath) {
