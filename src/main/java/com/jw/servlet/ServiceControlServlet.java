...
import com.jw.service.web.AnalyzeUriService;
import com.jw.util.JwProp;
...
public class ServiceControlServlet extends HttpServlet {
	...
	private void moveToNextPage(HttpServletRequest request, HttpServletResponse response,
		...
		if ("redirect".equals(respKind)) {
			...
			String redirectUrl = new JwProp().get("servlet.redirect.basepath") + output.getString("destination");
			...
			String forwardPath = new JwProp().get("servlet.forward.basepath") + output.getString("destination");
